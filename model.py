...
if __name__ == '__main__':
    ...
    # 2. Train the model
    trained_model, training_history = train_model(X, y, model_path='spy_lstm_model.keras', scaler_path=scaler_filename) # Changed extension to .keras

    # Example of how to load the model and scaler later (in app.py)
    # from tensorflow.keras.models import load_model
    # loaded_model = load_model('spy_lstm_model.keras')
    # loaded_scaler = joblib.load('spy_scaler.gz')
    # print("Model and scaler loaded successfully (example).")
    ...
    if len(X) > 0:
        ...
        # Note: This prediction is on the last day of the *training* data, not truly "tomorrow" from live data.
        # For a live prediction, you'd fetch up-to-the-minute data.
    else:
